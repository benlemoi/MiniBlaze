...
miniblaze_lib.add_source_files(join(root, 'src', 'hw1', 'spec_reg_pkg.vhd'))
miniblaze_lib.add_source_files(join(root, 'src', 'hw1', 'Sequencer.vhd'))
...
miniblaze_lib.add_source_files(join(root, 'test', 'Simu', 'tb_sequencer_pkg.vhd'))
miniblaze_lib.add_source_files(join(root, 'test', 'Simu', 'tb_sequencer.vhd'))
